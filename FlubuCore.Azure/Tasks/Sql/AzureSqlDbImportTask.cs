...
{
     public partial class AzureSqlDbImportTask : ExternalProcessTaskBase<AzureSqlDbImportTask>
     {
        
        /// <summary>
        /// Imports a bacpac into an existing database.
        /// </summary>
        public AzureSqlDbImportTask(string adminPassword = null ,  string adminUser = null ,  string name = null ,  string resourceGroup = null ,  string server = null ,  string storageKey = null ,  string storageKeyType = null ,  string storageUri = null)
        {
            WithArguments("az sql db import");
...
WithArguments("--storage-uri");
        ...
        /// </summary>
        public AzureSqlDbImportTask AuthType(string authType = null)
        {
