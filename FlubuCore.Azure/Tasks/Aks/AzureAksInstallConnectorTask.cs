...
{
     public partial class AzureAksInstallConnectorTask : ExternalProcessTaskBase<AzureAksInstallConnectorTask>
     {
        
        /// <summary>
        /// (PREVIEW) Install the ACI Connector on a managed Kubernetes cluster.
        /// </summary>
        public AzureAksInstallConnectorTask(string name = null ,  string resourceGroup = null)
        {
            WithArguments("az aks install-connector");
WithArguments("--name");
...
WithArguments("--resource-group");
        ...
        /// </summary>
        public AzureAksInstallConnectorTask AciResourceGroup(string aciResourceGroup = null)
        {
        ...
        /// </summary>
        public AzureAksInstallConnectorTask ChartUrl(string chartUrl = null)
        {
        ...
        /// </summary>
        public AzureAksInstallConnectorTask ClientSecret(string clientSecret = null)
        {
        ...
        /// </summary>
        public AzureAksInstallConnectorTask ConnectorName(string connectorName = null)
        {
        ...
        /// </summary>
        public AzureAksInstallConnectorTask ImageTag(string imageTag = null)
        {
        ...
        /// </summary>
        public AzureAksInstallConnectorTask Location(string location = null)
        {
        ...
        /// </summary>
        public AzureAksInstallConnectorTask OsType(string osType = null)
        {
        ...
        /// </summary>
        public AzureAksInstallConnectorTask ServicePrincipal(string servicePrincipal = null)
        {
