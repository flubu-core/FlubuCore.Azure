...
{
     public partial class AzureCosmosdbUpdateTask : ExternalProcessTaskBase<AzureCosmosdbUpdateTask>
     {
        
        /// <summary>
        /// Update an Azure Cosmos DB database account.
        /// </summary>
        public AzureCosmosdbUpdateTask(string name = null ,  string resourceGroup = null)
        {
            WithArguments("az cosmosdb update");
WithArguments("--name");
...
WithArguments("--resource-group");
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask Capabilities(string capabilities = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask DefaultConsistencyLevel(string defaultConsistencyLevel = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask EnableAutomaticFailover(string enableAutomaticFailover = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask EnableVirtualNetwork(string enableVirtualNetwork = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask IpRangeFilter(string ipRangeFilter = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask Locations(string locations = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask MaxInterval(string maxInterval = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask MaxStalenessPrefix(string maxStalenessPrefix = null)
        {
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask Tags(string tags = null)
        {
            WithArguments("--tags");
        ...
        /// </summary>
        public AzureCosmosdbUpdateTask VirtualNetworkRules(string virtualNetworkRules = null)
        {
