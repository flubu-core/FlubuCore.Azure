...
{
     public partial class AzureFunctionappDeploymentSourceConfigTask : ExternalProcessTaskBase<AzureFunctionappDeploymentSourceConfigTask>
     {
        
        /// <summary>
        /// Manage deployment from git or Mercurial repositories.
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask(string name = null ,  string repoUrl = null ,  string resourceGroup = null)
        {
            WithArguments("az functionapp deployment source config");
WithArguments("--name");
...
WithArguments("--resource-group");
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask Branch(string branch = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask GitToken(string gitToken = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask ManualIntegration(string manualIntegration = null)
        {
        ...
        /// Repository type.
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask RepositoryType(string repositoryType = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask AppWorkingDir(string appWorkingDir = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask CdAccountCreate(string cdAccountCreate = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask CdAppType(string cdAppType = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask CdProjectUrl(string cdProjectUrl = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask NodejsTaskRunner(string nodejsTaskRunner = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask PrivateRepoPassword(string privateRepoPassword = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask PrivateRepoUsername(string privateRepoUsername = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask PythonFramework(string pythonFramework = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask PythonVersion(string pythonVersion = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask SlotSwap(string slotSwap = null)
        {
        ...
        /// </summary>
        public AzureFunctionappDeploymentSourceConfigTask Test(string test = null)
        {
            WithArguments("--test");
