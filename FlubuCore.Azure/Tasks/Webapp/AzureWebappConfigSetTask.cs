...
{
     public partial class AzureWebappConfigSetTask : ExternalProcessTaskBase<AzureWebappConfigSetTask>
     {
        
        /// <summary>
        /// Set a web app's configuration.
        /// </summary>
        public AzureWebappConfigSetTask(string name = null ,  string resourceGroup = null)
        {
            WithArguments("az webapp config set");
WithArguments("--name");
...
WithArguments("--resource-group");
        ...
        /// </summary>
        public AzureWebappConfigSetTask AlwaysOn(string alwaysOn = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask AutoHealEnabled(string autoHealEnabled = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask FtpsState(string ftpsState = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask Http20Enabled(string http20Enabled = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask JavaContainer(string javaContainer = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask JavaContainerVersion(string javaContainerVersion = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask JavaVersion(string javaVersion = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask LinuxFxVersion(string linuxFxVersion = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask MinTlsVersion(string minTlsVersion = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask NetFrameworkVersion(string netFrameworkVersion = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask PhpVersion(string phpVersion = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask PythonVersion(string pythonVersion = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask RemoteDebuggingEnabled(string remoteDebuggingEnabled = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask Slot(string slot = null)
        {
            WithArguments("--slot");
        ...
        /// </summary>
        public AzureWebappConfigSetTask StartupFile(string startupFile = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask Use32bitWorkerProcess(string use32bitWorkerProcess = null)
        {
        ...
        /// </summary>
        public AzureWebappConfigSetTask WebSocketsEnabled(string webSocketsEnabled = null)
        {
