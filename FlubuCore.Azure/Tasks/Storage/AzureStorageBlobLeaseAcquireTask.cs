...
{
     public partial class AzureStorageBlobLeaseAcquireTask : ExternalProcessTaskBase<AzureStorageBlobLeaseAcquireTask>
     {
        
        /// <summary>
        /// Requests a new lease.
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask(string blobName = null ,  string containerName = null)
        {
            WithArguments("az storage blob lease acquire");
...
WithArguments("--container-name");
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask AuthMode(string authMode = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask LeaseDuration(string leaseDuration = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask ProposedLeaseId(string proposedLeaseId = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask Timeout(string timeout = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask IfMatch(string ifMatch = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask IfModifiedSince(string ifModifiedSince = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask IfNoneMatch(string ifNoneMatch = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask IfUnmodifiedSince(string ifUnmodifiedSince = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask AccountKey(string accountKey = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask AccountName(string accountName = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask ConnectionString(string connectionString = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseAcquireTask SasToken(string sasToken = null)
        {
