...
{
     public partial class AzureStorageBlobLeaseBreakTask : ExternalProcessTaskBase<AzureStorageBlobLeaseBreakTask>
     {
        
        /// <summary>
        /// Breaks the lease, if the blob has an active lease.
        /// </summary>
        public AzureStorageBlobLeaseBreakTask(string blobName = null ,  string containerName = null)
        {
            WithArguments("az storage blob lease break");
...
WithArguments("--container-name");
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask AuthMode(string authMode = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask LeaseBreakPeriod(string leaseBreakPeriod = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask Timeout(string timeout = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask IfMatch(string ifMatch = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask IfModifiedSince(string ifModifiedSince = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask IfNoneMatch(string ifNoneMatch = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask IfUnmodifiedSince(string ifUnmodifiedSince = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask AccountKey(string accountKey = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask AccountName(string accountName = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask ConnectionString(string connectionString = null)
        {
        ...
        /// </summary>
        public AzureStorageBlobLeaseBreakTask SasToken(string sasToken = null)
        {
